      ...
      <div className="text-center max-w-5xl mx-auto relative">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-cyan-400 text-sm font-semibold tracking-wider">FRONTEND ENGINEER</span>
            <Sparkles className="text-cyan-400 animate-pulse" size={24} />
          </div>
        ...
        <button onClick={() => scrollToSection('about')} className="animate-bounce inline-block">
